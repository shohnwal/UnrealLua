...
LUAI_FUNC lu_byte luaH_getshortstr (Table *t, TLuaString *key, TValue *res);
LUAI_FUNC lu_byte luaH_getstr (Table *t, TLuaString *key, TValue *res);
LUAI_FUNC lu_byte luaH_getint (Table *t, lua_Integer key, TValue *res);

/* Special get for metamethods */
LUAI_FUNC const TValue *luaH_Hgetshortstr (Table *t, TLuaString *key);

LUAI_FUNC int luaH_psetint (Table *t, lua_Integer key, TValue *val);
LUAI_FUNC int luaH_psetshortstr (Table *t, TLuaString *key, TValue *val);
LUAI_FUNC int luaH_psetstr (Table *t, TLuaString *key, TValue *val);
