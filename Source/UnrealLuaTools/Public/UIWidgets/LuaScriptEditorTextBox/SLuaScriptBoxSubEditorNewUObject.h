...
class UNREALLUATOOLS_API SLuaScriptBoxSubEditorNewUObject : public SLuaScriptBoxSubEditorNewObjectBase
{
public:
	SLATE_BEGIN_ARGS(SLuaScriptBoxSubEditorNewUObject)
		{
		}
	...
	virtual void SetSelectedStruct(FName selectedStructFullPath) override;
