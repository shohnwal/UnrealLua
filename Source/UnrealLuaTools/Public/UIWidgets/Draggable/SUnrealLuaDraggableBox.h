 ...
 */
class UNREALLUATOOLS_API SUnrealLuaDraggableBox : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SUnrealLuaDraggableBox)
		: _IsDraggable(true)
	{}
...
void Construct(const FArguments& InArgs, const TSharedRef<SUnrealLuaDraggableBoxOverlay>& InDraggableOverlay);
...
protected:
	...
	TWeakPtr<SUnrealLuaDraggableBoxOverlay> DraggableOverlayWeak;
